...
public class TC_Rate_Request_SC35 extends Keywords {




	public void rate_Request_Sc35(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset){

		String testcase_Name="TC_Rate_Request_SC35";
		...
		Extent_completed("TC_Rate_Request_SC35", test, test1);
	}}
