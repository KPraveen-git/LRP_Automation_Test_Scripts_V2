...
public class TC_Rate_Request_SC34  extends Keywords{

	public void rate_Request_Sc34(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset){

		String testcase_Name="TC_Rate_Request_SC34";
		...
		Extent_completed("TC_Rate_Request_SC34", test, test1);
