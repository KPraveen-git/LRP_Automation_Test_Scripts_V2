...
public class TC_Rate_Request_SC07 extends Keywords {

	public void Rate_Request_SC07(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset) {
		...
		Map<String, String> Excel_data = Utils.GetAllData(Sheet_Name_07, testCaseName,"Dataset" + selected_dataset, File_Path);
