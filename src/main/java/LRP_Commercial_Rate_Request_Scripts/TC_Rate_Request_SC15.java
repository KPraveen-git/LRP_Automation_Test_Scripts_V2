...
public class TC_Rate_Request_SC15 extends Keywords {
	...
	public void Rate_RequestSC15(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
			throws Exception {

		String testcase_Name="TC_Rate_Request_SC15";
