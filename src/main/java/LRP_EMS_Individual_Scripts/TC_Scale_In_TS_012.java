...
public class TC_Scale_In_TS_012 extends Keywords {
	...
	public void Scaleoutdelete(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
			throws Exception {
		...
		// LOGIN	String Condition_Filter = dataa.get("Condition_Filter");
