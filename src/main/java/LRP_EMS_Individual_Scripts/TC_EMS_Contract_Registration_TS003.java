...
public void Emscontractregistration03(WebDriver driver,ExtentTest test,ExtentTest test1, String selected_dataset) throws Exception 
{
...
//	sendKeys(driver, search_contractfield, contract_no3);
...
//    click(driver,search_selecticon);
	...
	Step_Start(11, "Click on Delete icon from toolbar", test, test1);
	    ...
	    click(driver,delete_icon);
		Step_End(11, "Click on Delete icon from toolbar", test, test1);

	    waitForElement(driver, delete_confirm_message);
	    String confirm_delete= getText(driver, delete_confirm_message);
	    
	    if(confirm_delete.equals(delete_confirm)) {
	    	System.out.println("Matched || Expected value was : "+delete_confirm+" || Actual value was : "+confirm_delete);
	    	Extent_pass(driver, "Matched || Expected value was : "+delete_confirm+" || Actual value was : "+confirm_delete, test, test1);
	    }else {
	    	System.out.println("Not Matched || Expected value was : "+delete_confirm+" || Actual value was : "+confirm_delete);
	    	Extent_fail(driver,  "Not Matched || Expected value was : "+delete_confirm+" || Actual value was : "+confirm_delete, test, test1);
	    }
	    
		Step_Start(12, "Click on 'Yes' when pop-up message occurs for confirmation message", test, test1);
	    waitForElement(driver, click_yesbutton);
	    click(driver,click_yesbutton);
	    ...
	    waitForElement(driver, deleted_message);
	    String delete_msg= getText(driver, deleted_message);

	    if(delete_msg.equals(Deleted_Message)) {
	    	System.out.println("Matched || Expected value was : "+Deleted_Message+" || Actual value was : "+delete_msg);
	    	Extent_pass(driver, "Matched || Expected value was : "+Deleted_Message+" || Actual value was : "+delete_msg, test, test1);
	    }else {
	    	System.out.println("Not Matched || Expected value was : "+Deleted_Message+" || Actual value was : "+delete_msg);
	    	Extent_fail(driver,  "Not Matched || Expected value was : "+Deleted_Message+" || Actual value was : "+delete_msg, test, test1);
	    	}
