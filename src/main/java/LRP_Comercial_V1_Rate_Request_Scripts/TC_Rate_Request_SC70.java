...
public class TC_Rate_Request_SC70   extends Keywords {
	public static String tService;
	public static String TOS;
	public void Rate_Request_SC70(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
			throws Exception {

		String testCase_Name="TC_Rate_Request_SC70";
		...
		String Exp_Det_Days_Input1 = Data.get("Exp_Det_Days_Input1");
		String Imp_Det_Days_Input1 = Data.get("Imp_Det_Days_Input1");
		String Exp_Demmurage_Input1 = Data.get("Exp_Demmurage_Input1");
		String Imp_Demmurage_Input1 = Data.get("Imp_Demmurage_Input1");
		String Exp_Det_Days_Input2 = Data.get("Exp_Det_Days_Input2");
		String Imp_Det_Days_Input2 = Data.get("Imp_Det_Days_Input2");
		String Exp_Demmurage_Input2 = Data.get("Exp_Demmurage_Input2");
		String Imp_Demmurage_Input2 = Data.get("Imp_Demmurage_Input2");
		String agencyUser = Data.get("Agency_user");
		String SOC_checkbox1 = Data.get("SOC_checkbox1");
		String NOR_checkbox1 = Data.get("NOR_checkbox1");
		String OOG_checkbox1 = Data.get("OOG_checkbox1");
		String DG_checkboxs1 = Data.get("DG_checkboxs1");
		String SOC_checkbox2 = Data.get("SOC_checkbox2");
		String MTY_checkbox1 = Data.get("MTY_checkbox1");
		String MTY_checkbox2 = Data.get("MTY_checkbox2");
		String NOR_checkbox2 = Data.get("NOR_checkbox2");
		String OOG_checkbox2 = Data.get("OOG_checkbox2");
		String DG_checkboxs2 = Data.get("DG_checkboxs2");
		...
		String Pre_Carriage_Radiobtn1 = Data.get("pre_Carriage_Radiobtn1");
		String On_Carriage_Radiobtn1 = Data.get("On_Carriage_Radiobtn1");
		String Pre_Carriage_Radiobtn2 = Data.get("pre_Carriage_Radiobtn2");
		String On_Carriage_Radiobtn2 = Data.get("On_Carriage_Radiobtn2");
		...
		String preCarriageLocator1 = String.format(Rate_Request_Loactors.pre_Carriage_Radiobtn, Pre_Carriage_Radiobtn1);
		String onCarriageLocator1 =  String.format(Rate_Request_Loactors.on_Carriage_Radiobtn,  On_Carriage_Radiobtn1); 
		String preCarriageLocator2 = String.format(Rate_Request_Loactors.pre_Carriage_Radiobtn, Pre_Carriage_Radiobtn2);
		String onCarriageLocator2 =  String.format(Rate_Request_Loactors.on_Carriage_Radiobtn,  On_Carriage_Radiobtn2); 
		...
		if(isdisplayed(driver,pop_up_exp )) {
			...
			checkBox(driver, DG_checkbox, DG_checkboxs1);

			checkBox(driver, oog_checkbox, OOG_checkbox1);

			checkBox(driver, nor_checkbox, NOR_checkbox1);

			checkBox(driver, soc_checkbox, SOC_checkbox1);
			if(MTY_checkbox1.equalsIgnoreCase("Yes")) {
				waitForElement(driver, MTY_checkbox);
				checkBox(driver, MTY_checkbox, MTY_checkbox1);
			}
			//Pre Carriage radio btn
			waitForElement(driver, preCarriageLocator1);
			click(driver, preCarriageLocator1);
			waitForElement(driver, onCarriageLocator1);
			click(driver, onCarriageLocator1);

			waitForDisplay(driver, Exp_Days);
			if(isdisplayed(driver, Exp_Days)&&isElementAccessible(driver, Exp_Days)) {
				clear(driver, Exp_Days);
				sendKeys(driver, Exp_Days, Exp_Det_Days_Input1);
			}
			if(isdisplayed(driver, Imp_Days)&&isElementAccessible(driver, Imp_Days)) {
				clear(driver, Imp_Days);
				sendKeys(driver, Imp_Days, Imp_Det_Days_Input1);
			}
			if(isdisplayed(driver, Exp_Demurage)&&isElementAccessible(driver, Exp_Demurage)) {
				clear(driver, Exp_Demurage);
				sendKeys(driver, Exp_Demurage, Exp_Demmurage_Input1);
			}
			if(isdisplayed(driver, Imp_Demurage)&&isElementAccessible(driver, Imp_Demurage)) {
				clear(driver, Imp_Demurage);
				sendKeys(driver, Imp_Demurage, Imp_Demmurage_Input1);
			}
			...
			checkBox(driver, DG_checkbox, DG_checkboxs2);

			waitForElement(driver, oog_checkbox);
			checkBox(driver, oog_checkbox, OOG_checkbox2);

			waitForElement(driver, nor_checkbox);
			checkBox(driver, nor_checkbox, NOR_checkbox2);

			waitForElement(driver, soc_checkbox);
			checkBox(driver, soc_checkbox, SOC_checkbox2);

			waitForElement(driver, MTY_checkbox);
			checkBox(driver, MTY_checkbox, MTY_checkbox2);

			//Pre Carriage radio btn
			waitForElement(driver, preCarriageLocator2);
			click(driver, preCarriageLocator2);
			waitForElement(driver, onCarriageLocator2);
			click(driver, onCarriageLocator2);

			waitForDisplay(driver, Exp_Days);
			if(isdisplayed(driver, Exp_Days)&&isElementAccessible(driver, Exp_Days)) {
				clear(driver, Exp_Days);
				sendKeys(driver, Exp_Days, Exp_Det_Days_Input2);
			}
			if(isdisplayed(driver, Imp_Days)&&isElementAccessible(driver, Imp_Days)) {
				clear(driver, Imp_Days);
				sendKeys(driver, Imp_Days, Imp_Det_Days_Input2);
			}
			if(isdisplayed(driver, Exp_Demurage)&&isElementAccessible(driver, Exp_Demurage)) {
				clear(driver, Exp_Demurage);
				sendKeys(driver, Exp_Demurage, Exp_Demmurage_Input2);
			}
			if(isdisplayed(driver, Imp_Demurage)&&isElementAccessible(driver, Imp_Demurage)) {
				clear(driver, Imp_Demurage);
				sendKeys(driver, Imp_Demurage, Imp_Demmurage_Input2);
			}
			Step_Start(9, "Click routing", test, test1);
