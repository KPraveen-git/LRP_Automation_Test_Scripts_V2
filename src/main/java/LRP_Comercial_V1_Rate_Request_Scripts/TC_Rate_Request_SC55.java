...
public class TC_Rate_Request_SC55  extends Keywords{
	...
	public void Rate_Request_SC55(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
			throws Exception {
		
		String tc_Name="TC_Rate_Request_SC55";
...
Step_Start(24, "click Back button ", test, test1);
	waitForElement(driver, back_date);
click(driver, back_date);
Step_End(24, "click Back button ", test, test1);	
