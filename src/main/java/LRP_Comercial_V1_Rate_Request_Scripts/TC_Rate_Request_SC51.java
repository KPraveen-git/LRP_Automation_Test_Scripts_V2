...
public class TC_Rate_Request_SC51 extends Keywords{

	public void Rate_Request_SC51(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset){


		String testCase_Name="TC_Rate_Request_SC51";
		...
		if(isDisplayed(driver,pop_up_exp )) {
			...
			ResetProfile(driver);
				...
				waitForElement(driver, accept_btn_srr);
				if(isElementEnabled(driver, accept_btn_srr)) {
				click(driver, accept_btn_srr);
				}else {
					waitForElement(driver, SRR_Contribution);
					click(driver, SRR_Contribution);
					String missingCost = getText(driver, SRR_Missing_Cost_Value);
