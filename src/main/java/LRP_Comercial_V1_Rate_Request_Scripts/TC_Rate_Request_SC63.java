...
public class TC_Rate_Request_SC63 extends Keywords{

	public void Rate_Request_SC63(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset){
		
		String testcase_Name="TC_Rate_Request_SC63";
		...
		String already_Exist_Popup=data.get("Already_Exist_Popup");
...
//		//RadioButton
		...
		String exist_PopUp_Msg=getText(driver, Popup_Message);      
		System.out.println("PopUp_Msg : "+exist_PopUp_Msg);   
		if(already_Exist_Popup.equals(exist_PopUp_Msg)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + already_Exist_Popup + " || Actual Report Activity is : " + exist_PopUp_Msg);            
			Extent_pass(driver, "Matched || " + " Expected Report Activity is : " + already_Exist_Popup + " || Actual Report Activity is : " + exist_PopUp_Msg, test,test1);     
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + already_Exist_Popup + " || Actual Report Activity is : " + exist_PopUp_Msg);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + already_Exist_Popup + " || Actual Report Activity is : " + exist_PopUp_Msg, test,test1); 
		}
