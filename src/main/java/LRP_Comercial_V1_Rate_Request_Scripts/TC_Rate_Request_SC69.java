...
public class TC_Rate_Request_SC69 extends Keywords{

	public void Rate_Request_SC69(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset){
		
		String testcase_Name="TC_Rate_Request_SC69";
	...
	moduleNavigate(driver, search_module);
	   ...
	   globalValueSearchWindow1(driver, condition_Option, customerCode_Option, customerCode, search2, input2, search3, input3);
		...
		Extent_pass(driver, "Passed || MTY Checkbox enabled after click on SOC checkbox", test, test1);
