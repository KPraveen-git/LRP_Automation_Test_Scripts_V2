...
public class TC_Rate_Request_SC44 extends Keywords {

	public void Rate_Request_SC44(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset) {
		String testCaseName="TC_Rate_Request_SC44";
...
//			click(driver, filter_Inputfield);
			...
			waitForElement(driver, specialRateRequest_Approve_Button);
			click(driver, specialRateRequest_Approve_Button);
