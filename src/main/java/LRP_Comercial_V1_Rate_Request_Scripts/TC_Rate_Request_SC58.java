...
public class TC_Rate_Request_SC58  extends Keywords {
	public static String Pre_Carriage_Radiobtn;
	public static String On_Carriage_Radiobtn;
	public static String tService;
	public static String TOS;

	public void Rate_Request_SC58(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
			throws Exception {

		String testCase_Name="TC_Rate_Request_SC58";
		...
		String Back_Date_Input = Data.get("Back_Date_Input");
		...
		if(isdisplayed(driver,pop_up_exp )) {
			...
			if(isdisplayed(driver,pop_up_exp )) {
				...
				click(driver, toolBar_Edit_Button);
				scrollBottom(driver);
				waitForElement(driver, back_Date_Button);
				click(driver, back_Date_Button);
				waitForElement(driver, back_Date_Input_Field);
				click(driver, back_Date_Input_Field);
				clear(driver, back_Date_Input_Field);
				sendKeys(driver, back_Date_Input_Field, Back_Date_Input);
				
				
				waitForElement(driver, back_Date_Ok_Button);
				click(driver, back_Date_Ok_Button);
