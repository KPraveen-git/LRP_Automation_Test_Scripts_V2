...
public class TC_Rate_Request_SC62  extends Keywords{
	...
	public void Rate_Request_SC62(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
			throws Exception {
		
		String tc_Name="TC_Rate_Request_SC62";
