...
public class TC_Rate_Request_SC64 extends Keywords{

	public void Rate_Request_SC64(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset){
		
		String testcase_Name="TC_Rate_Request_SC64";
...
//		//RadioButton
		...
		twoColumnSearchWindow(driver, condition, Select_type_location, payLocation);
			...
			System.out.println("Pay Location Search Button Disabled for "+paymentMode);
			Extent_pass(driver, "Pay Location Search Button Disabled for "+paymentMode, test, test1);
			}else {
