...
public class TC_Rate_Request_SC45 extends Keywords {
	public static String Pre_Carriage_Radiobtn;
	public static String On_Carriage_Radiobtn;
	public static String tService;
	public static String TOS;

	public void Rate_Request_SC45(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset) {
		String testCaseName="TC_Rate_Request_SC45";
		...
		String min_Base_Rate_Input = Data.get("min_Base_Rate_Input");
		String rate_Select_Type = Data.get("rate_Select_Type");
		String min_Base_Rate_Quantity_Input = Data.get("min_Base_Rate_Quantity_Input");
		String SRR_Status = Data.get("SRR_Status").trim();
		String SRR_Grid_Status = Data.get("SRR_Grid_Status").trim();
		String rate_Calc_Type = Data.get("rate_Calc_Type").trim();
		tService=Data.get("T_Service");
		TOS=Data.get("TOS_Option");
		String dim_Gross_Weight_Input = Data.get("dim_Gross_Weight_Input");
		String dimension_Length_Input = Data.get("dimension_Length_Input");
		String dimension_Width_Input = Data.get("dimension_Width_Input");
		String dimension_Height_Input = Data.get("dimension_Height_Input");
		String dimension_Quantity_Input = Data.get("dimension_Quantity_Input");
		...
		if(isdisplayed(driver,pop_up_exp )) {
			...
			waitForElement(driver, rate_Type);
			click(driver, rate_Type);
			String rate_Type_Select = String.format(Rate_Request_Loactors.ratetype_Select, rate_Select_Type);
			waitForElement(driver, rate_Type_Select);
			click(driver, rate_Type_Select);



			Step_Start(7, "Enter the rate calc  type.", test, test1);
			waitForElement(driver, rate_Calculation_Type);
			click(driver, rate_Calculation_Type);
			sendKeys(driver, rate_Calculation_Type, rate_Calc_Type);
			waitForElement(driver, Auto_Panel_First);
			safeclick(driver, Auto_Panel_First);
			Step_End(7, "Enter the rate calc type.", test, test1);
			...
			waitForElement(driver, min_Base_Rate);
			clearAndType(driver, min_Base_Rate, min_Base_Rate_Input);

			waitForElement(driver, min_Base_Rate_Quantity);
			clearAndType(driver, min_Base_Rate_Quantity, min_Base_Rate_Quantity_Input);
			...
			waitForElement(driver, add_Dimensions_Button);
			click(driver, add_Dimensions_Button);

			waitForElement(driver, dimension_Grs_Weight);
			clearAndType(driver, dimension_Grs_Weight, dim_Gross_Weight_Input);
			click(driver, dimension_Grs_Weight);

			waitForElement(driver, dimension_Length);
			clearAndType(driver, dimension_Length, dimension_Length_Input);
			click(driver, dimension_Length);

			waitForElement(driver, dimension_Width);
			clearAndType(driver, dimension_Width, dimension_Width_Input);
			click(driver, dimension_Width);

			waitForElement(driver, dimension_Height);
			clearAndType(driver, dimension_Height, dimension_Height_Input);
			click(driver, dimension_Height);


			waitForElement(driver, dimension_Quantity);
			clearAndType(driver, dimension_Quantity, dimension_Quantity_Input);
			click(driver, dimension_Quantity);
			...
			waitForElement(driver, dimension_Ok_Button);
			click(driver, dimension_Ok_Button);
