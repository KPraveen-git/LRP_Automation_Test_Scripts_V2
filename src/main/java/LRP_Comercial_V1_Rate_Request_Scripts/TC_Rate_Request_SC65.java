...
public class TC_Rate_Request_SC65 extends Keywords {
	...
	public void SaveTheRecord(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
		...
		String tc_Name="TC_Rate_Request_SC65";
		...
		String Pending_pop_up =Data.get("Pending_pop_up");
		String Rejected_popup= Data.get("Rejected_popup");
		...
		if(isDisplayed(driver,pop_up_exp )) {
			...
			Step_End(12, "Enter the OFR", test, test1);
			 ...
			 Step_Start(13, ".Click Add", test, test1);
				...
				System.out.println("actSubmitPopup :"+actSubmitPopup);
				
				if(Pending_pop_up.equals(actSubmitPopup)) {
					Extent_pass(driver,"Matched || Expected : "+ Pending_pop_up+" Actual : "+ actSubmitPopup, test,test1);
					System.out.println("Matched || Expected : " +Pending_pop_up+" Actual : "+ actSubmitPopup);
					Extent_pass(driver, Pending_pop_up+" is displayed", test,test1);
					System.out.println(Pending_pop_up+" is displayed");

				}else {
					System.out.println("Not Matched || Expected : "+Pending_pop_up+" Actual : "+ actSubmitPopup);

					Extent_fail(driver,"Not Matched || Expected : "+Pending_pop_up+" Actual : "+ actSubmitPopup, test,test1);
				}
				...
				if(Rejected_popup.equals(actualPopup)) {
					Extent_pass(driver,"Matched || Expected : "+Rejected_popup+" Actual : "+ actualPopup, test,test1);
					System.out.println("Matched || Expected : "+Rejected_popup+" Actual : "+ actualPopup);
					Extent_pass(driver, Rejected_popup+" popup is displayed", test,test1);
					System.out.println(Rejected_popup+" popup is displayed");


				}else {
					System.out.println("Not Matched || Expected : "+Rejected_popup+" Actual : "+ actualPopup);

					Extent_fail(driver,"Not Matched || Expected : "+Rejected_popup+" Actual : "+ actualPopup, test,test1);
				}
				...
				System.out.println("actSubmittedPopup :"+actSubmittedPopup);
		

				if(Submitted_popup.equals(actSubmittedPopup)) {
					Extent_pass(driver,"Matched || Expected : "+Submitted_popup+" Actual : "+ actSubmittedPopup, test,test1);
					System.out.println("Matched || Expected : "+Submitted_popup+" Actual : "+ actSubmittedPopup);
					Extent_pass(driver, Submitted_popup+" popup is displayed", test,test1);
					System.out.println(Submitted_popup+" popup is displayed");

				}else {
					System.out.println("Not Matched || Expected : "+Submitted_popup+" Actual : "+ actSubmittedPopup);
					Extent_fail(driver,"Not Matched || Expected : "+Submitted_popup+" Actual : "+ actSubmittedPopup, test,test1);
				}
