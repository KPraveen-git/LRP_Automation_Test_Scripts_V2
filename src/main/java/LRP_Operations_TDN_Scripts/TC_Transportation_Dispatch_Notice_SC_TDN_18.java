...
public class TC_Transportation_Dispatch_Notice_SC_TDN_18 extends Keywords{

	public void Transportation_Dispatch_Notice_SC_TDN_18(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {
		
		
		
		String tc_Name="TC_Transportation_Dispatch_Notice_SC_TDN_18";

		String File_Path_SC18 = TestNgXml.getfilePath_FromExecution().get(tc_Name);
		String Sheet_Name_SC18 = TestNgXml.getsheetName_FromExecution().get(tc_Name);
		String url = TestNgXml.getdatafromExecution().get(tc_Name);
		Map<String, String> TDN_SC_18 = Utils.GetAllData(Sheet_Name_SC18, tc_Name, "Dataset"+selected_dataset, File_Path_SC18);
		
		
		String username=TDN_SC_18.get("Username");
		String password=TDN_SC_18.get("Password");
		String moduleTDN=TDN_SC_18.get("ModuleTDN");
		String agencyUser = TDN_SC_18.get("AgencyUser");
		String Booking_Number =TDN_SC_18.get("Booking_Number");
		String Provisional_perform =TDN_SC_18.get("Provisional_perform");
		String Draft_perform =TDN_SC_18.get("Draft_perform");
		String Confirmed_perform =TDN_SC_18.get("Confirmed_perform");
		String Cancelled_perform =TDN_SC_18.get("Cancelled_perform");
		String Shipment_Type =TDN_SC_18.get("Shipment_Type");
		String Booking_Number_perform =TDN_SC_18.get("Booking_Number_perform");
		String Ware_House_number =TDN_SC_18.get("Ware_House_number");
		String Trans_select =TDN_SC_18.get("Trans_select");
		String App_Date =TDN_SC_18.get("App_Date");
		String date_Picker =TDN_SC_18.get("date_Picker");
		String tdn_SavedPopup =TDN_SC_18.get("TDN_SavedPopup");
		String Modeof_Transport =TDN_SC_18.get("Modeof_Transport");
		String Modeof_Transport_Type =TDN_SC_18.get("Modeof_Transport_Type");
		String Vender_Code =TDN_SC_18.get("Vender_Code");
		String Modeof_Transport1 =TDN_SC_18.get("Modeof_Transport1");
		String Transportation_saved =TDN_SC_18.get("Transportation_saved");
		String Global_search_Wo_No =TDN_SC_18.get("Global_search_Wo_No");
		String Global_search_Vendor_Code_Option1 =TDN_SC_18.get("Global_search_Vendor_Code_Option1");
		String Global_search_Option1 =TDN_SC_18.get("Global_search_Option1");
		String Dropdown_Condition =TDN_SC_18.get("Dropdown_Condition");
		String merchantPopup =TDN_SC_18.get("MerchantPopup");
		String pickup_loc_dd_data =TDN_SC_18.get("pickup_loc_dd_data");
		String pickup_loc_search_data =TDN_SC_18.get("pickup_loc_search_data");
		String condition =TDN_SC_18.get("condition");
		String cust_depot_term_data =TDN_SC_18.get("cust_depot_term_data");
		String cust_dep_search_data =TDN_SC_18.get("cust_dep_search_data");
		String return_loc_dd_data =TDN_SC_18.get("return_loc_dd_data");
		String return_loc_search_data =TDN_SC_18.get("return_loc_search_data");
		String leg_pickupdate =TDN_SC_18.get("leg_pickupdate");
		String leg_return_date =TDN_SC_18.get("leg_return_date");
		String with_chasis_flag =TDN_SC_18.get("with_chasis_flag");
		String chasis_pickup_dd_data =TDN_SC_18.get("chasis_pickup_dd_data");
		String chasis_drop_dd_data =TDN_SC_18.get("chasis_drop_dd_data");
		
		String cust_depot_term_header =TDN_SC_18.get("cust_depot_term_header");
		String return_location_header =TDN_SC_18.get("return_location_header");
		String pickup_location_header =TDN_SC_18.get("pickup_location_header");
		String chasis_pickup_header =TDN_SC_18.get("chasis_pickup_header");
		String chasis_drop_header =TDN_SC_18.get("chasis_drop_header");
		String chasis_pickup_Search_data =TDN_SC_18.get("chasis_pickup_Search_data");
		String chasis_drop_Search_data =TDN_SC_18.get("chasis_drop_Search_data");
		String Chassis_Mode =TDN_SC_18.get("Chassis_Mode");
		String Search_Type2 =TDN_SC_18.get("Search_Type2");
		String Search_Input2 =TDN_SC_18.get("Search_Input2");
		String Search_Type3 =TDN_SC_18.get("Search_Type3");
		String Search_Input3 =TDN_SC_18.get("Search_Input3");
...
//4
       ...
       waitForElement(driver, TDN_Popup_Msg);
		...
		if(actual_TDN_SavedPopup1.equals(Transportation_saved)) {
			Extent_pass(driver, "Matched || Expected save Pop-up : "+tdn_SavedPopup +" || Actual save Pop-up : "+actual_TDN_SavedPopup1, test, test1);
			System.out.println("Matched || Expected save Pop-up : "+tdn_SavedPopup +" || Actual save Pop-up : "+actual_TDN_SavedPopup1);
			click(driver, tdnPopup_Ok);
		}else {
			
			System.out.println("Not Matched || Expected save Pop-up : "+tdn_SavedPopup +" || Actual save Pop-up : "+actual_TDN_SavedPopup1);
			Extent_fail(driver, "Not Matched || Expected save Pop-up : "+tdn_SavedPopup +" || Actual save Pop-up : "+actual_TDN_SavedPopup1, test, test1);
		}
	    ...
	    click1(driver, edit_icon);
	    
	    Step_End(27, "Click the Edit Button.", test, test1);

	    waitForElement(driver, TDN_ref_scroll);
	    scrollUsingElement(driver, TDN_ref_scroll);
	    
	    horizontalscroll(driver, TDN_ref_scroll, 2000);
	    
	    String modevalue = getText(driver, get_modetype);
	    System.out.println("get_modetype:" + modevalue);
	    ...
	    Step_Start(29, "Click the mode of Transport drop down and select the Rail.", test, test1);

	    waitForElement(driver, modeof_transport);
		click(driver, modeof_transport);
		
		String Select_ModeOfTransport1=String.format(Tdn_Locators.Select_ModeOfTransport, Modeof_Transport1);

		safeclick(driver, Select_ModeOfTransport1);
		
	     Step_End(29, "Click the mode of Transport drop down and select the Rail.", test, test1);

	    Step_Start(30, "Click the Edit button.", test, test1);

	    waitForElement(driver, container_details_editbtn);
	    click(driver,container_details_editbtn);
	    
	    Step_End(30, "Click the Edit button.", test, test1);
		...
		waitForElement(driver, get_modetype);

	    String modevalue1 = getText(driver, get_modetype);
	    System.out.println("get_modetype:" + modevalue1);
	    
	    horizontalscroll(driver, TDN_ref_scroll, -2000);
	    
	    if(!modevalue.equals(modevalue1)) {                                                                                                                  
			System.out.println("Matched || " + " Previous transport mode  is : " + modevalue + " || transport mode after edit is : " + modevalue1);   
			Extent_pass(driver, "Matched || " + " Previous transport mode  is : " + modevalue + " || transport mode after edit is : " + modevalue1, test, test1);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Previous transport mode is : " + modevalue + " || transport mode after edit is : " + modevalue1);        
			Extent_fail(driver, "Not Matched || " + " Previous transport mode is : " + modevalue + " || transport mode after edit is : " + modevalue1, test,test1); 
		} 
	    ...
	    String Transportation_dispatch_savedpopup = getText(driver, TDN_Popup_Msg);
		System.out.println(Transportation_dispatch_savedpopup);
		
		if(Transportation_saved.equals(Transportation_dispatch_savedpopup)) {                                                                                                                  
			...
			Extent_pass(driver, "Matched || " + " Expected Report Activity is : " + Transportation_saved + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup, test, test1);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
