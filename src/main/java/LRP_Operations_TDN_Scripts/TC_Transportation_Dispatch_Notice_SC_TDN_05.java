...
public class TC_Transportation_Dispatch_Notice_SC_TDN_05 extends Keywords{
		public void Transportation_Dispatch_Notice_SC_TDN_05(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {
			...
			String PLD_Input =TDN_SC_05.get("PLD_Input");
			String PLD_Search =TDN_SC_05.get("PLD_Search");
			String PLA_Input =TDN_SC_05.get("PLA_Input");
			String PLA_Search =TDN_SC_05.get("PLA_Search");
			String Address1_Search =TDN_SC_05.get("Address1_Search");
			String Address1_Input =TDN_SC_05.get("Address1_Input");
			String Address2_Search =TDN_SC_05.get("Address2_Search");
			String Address2_Input =TDN_SC_05.get("Address2_Input");
			String Vendor_Input =TDN_SC_05.get("Vendor_Input");
			String Vendor_Name_Search =TDN_SC_05.get("Vendor_Name_Search");
			String Address_Input =TDN_SC_05.get("Address_Input");
			String Address_Search =TDN_SC_05.get("Address_Search");
			String pickup_location_header =TDN_SC_05.get("pickup_location_header");
			String return_location_header =TDN_SC_05.get("return_location_header");
			String chasis_pickup_header =TDN_SC_05.get("chasis_pickup_header");
			String chasis_drop_header =TDN_SC_05.get("chasis_drop_header");
			String cust_depot_term_header =TDN_SC_05.get("cust_depot_term_header");
