...
public class TC_Transportation_Dispatch_Notice_SC_TDN_21 extends Keywords{

	public void Transportation_Dispatch_Notice_SC_TDN_21(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {
		String testCase_Name ="TC_Transportation_Dispatch_Notice_SC_TDN_21";
		String File_Path_SC21 = TestNgXml.getfilePath_FromExecution().get(testCase_Name);
		String Sheet_Name_SC21 = TestNgXml.getsheetName_FromExecution().get(testCase_Name);
		String url = TestNgXml.getdatafromExecution().get(testCase_Name);
		Map<String, String> TDN_SC_21 = Utils.GetAllData(Sheet_Name_SC21, testCase_Name, "Dataset"+selected_dataset, File_Path_SC21);

		String username=TDN_SC_21.get("Username");
		String password=TDN_SC_21.get("Password");
		String moduleTDN=TDN_SC_21.get("ModuleTDN");
		String agencyUser = TDN_SC_21.get("AgencyUser");
		String Booking_Number1 =TDN_SC_21.get("Booking_Number1");
		String Booking_Number2 =TDN_SC_21.get("Booking_Number2");
		String Booking_Number3 =TDN_SC_21.get("Booking_Number3");
		String Provisional_perform =TDN_SC_21.get("Provisional_perform");
		String Confirmed_perform =TDN_SC_21.get("Confirmed_perform");
		String Cancelled_perform =TDN_SC_21.get("Cancelled_perform");
		String Shipment_Type =TDN_SC_21.get("Shipment_Type");
		String Booking_Number_perform =TDN_SC_21.get("Booking_Number_perform");
		String Booking_Number_Type_Select1 =TDN_SC_21.get("Booking_Number_Type_Select1");
		String Booking_Number_Type_Select2 =TDN_SC_21.get("Booking_Number_Type_Select2");
		String Booking_Number_Type_Select3 =TDN_SC_21.get("Booking_Number_Type_Select3");
		String Trans_select =TDN_SC_21.get("Trans_select");
		String App_Date =TDN_SC_21.get("App_Date");
		String date_Picker =TDN_SC_21.get("date_Picker");
		String tdn_SavedPopup =TDN_SC_21.get("TDN_SavedPopup");
		String Modeof_Transport =TDN_SC_21.get("Modeof_Transport");
		String Modeof_Transport_Type =TDN_SC_21.get("Modeof_Transport_Type");
		String Vender_Code =TDN_SC_21.get("Vender_Code");
		String Terminal_code_value =TDN_SC_21.get("Terminal_code_value");
		String Transportation_Updated =TDN_SC_21.get("Transportation_Updated");
		String Return_Date =TDN_SC_21.get("Return_Date");
		String merchantPopup =TDN_SC_21.get("MerchantPopup");
		String pickup_loc_dd_data =TDN_SC_21.get("pickup_loc_dd_data");
		String pickup_loc_search_data =TDN_SC_21.get("pickup_loc_search_data");
		String condition =TDN_SC_21.get("condition");
		String cust_depot_term_data =TDN_SC_21.get("cust_depot_term_data");
		String cust_dep_search_data =TDN_SC_21.get("cust_dep_search_data");
		String return_loc_dd_data =TDN_SC_21.get("return_loc_dd_data");
		String return_loc_search_data =TDN_SC_21.get("return_loc_search_data");
		String leg_date_Picker =TDN_SC_21.get("leg_date_Picker");
		String leg_pickupdate =TDN_SC_21.get("leg_pickupdate");
		String with_chasis_flag =TDN_SC_21.get("with_chasis_flag");
		String chasis_pickup_dd_data =TDN_SC_21.get("chasis_pickup_dd_data");
		String chasis_drop_dd_data =TDN_SC_21.get("chasis_drop_dd_data");
		String chasis_pickup_Search_data =TDN_SC_21.get("chasis_pickup_Search_data");
		String chasis_drop_Search_data =TDN_SC_21.get("chasis_drop_Search_data");
		String Chassis_Mode =TDN_SC_21.get("Chassis_Mode");
		String ware_House_Type_Select1 =TDN_SC_21.get("ware_House_Type_Select1");
		String Ware_House_number1 =TDN_SC_21.get("Ware_House_number1");
		String ware_House_Type_Select2 =TDN_SC_21.get("ware_House_Type_Select2");
		String Ware_House_number2 =TDN_SC_21.get("Ware_House_number2");
		String ware_House_Type_Select3 =TDN_SC_21.get("ware_House_Type_Select3");
		String Ware_House_number3 =TDN_SC_21.get("Ware_House_number3");
		String Dropdown_Condition =TDN_SC_21.get("Dropdown_Condition");
		String cust_depot_term_header =TDN_SC_21.get("cust_depot_term_header");
		String return_location_header =TDN_SC_21.get("return_location_header");
		String pickup_location_header =TDN_SC_21.get("pickup_location_header");
		String chasis_pickup_header =TDN_SC_21.get("chasis_pickup_header");
		String chasis_drop_header =TDN_SC_21.get("chasis_drop_header");
		String Global_search_Vendor_Code_Option1 =TDN_SC_21.get("Global_search_Vendor_Code_Option1");
		String Vendor_Search_Type2 =TDN_SC_21.get("Vendor_Search_Type2");
		String Vendor_Search_Input2 =TDN_SC_21.get("Vendor_Search_Input2");
		String Vendor_Search_Type3 =TDN_SC_21.get("Vendor_Search_Type3");
		String Vendor_Search_Input3 =TDN_SC_21.get("Vendor_Search_Input3");
		...
		String Select_ModeOfTransport_type=String.format(LoadConfirmation_Locators.Select_ModeOfTransport, Modeof_Transport_Type);
		...
		waitForElement(driver, Return_Location);
		click(driver,Return_Location);

		click(driver,Terminal_Code_Search);
		sendKeys(driver, Terminal_Code_Search, Terminal_code_value);
		...
		if(isElementEnabled(driver, vendor_Code_addbtn)) {
			waitForElement(driver, vendor_Code_addbtn);
			click(driver,vendor_Code_addbtn);
		}
		waitForDisplay(driver, tdnPopup_Ok);
