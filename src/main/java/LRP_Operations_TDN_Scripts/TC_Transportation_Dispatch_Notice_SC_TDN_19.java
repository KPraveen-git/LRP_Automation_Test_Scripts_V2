...
public class TC_Transportation_Dispatch_Notice_SC_TDN_19 extends Keywords{

	public void Transportation_Dispatch_Notice_SC_TDN_19(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {
		
		
		String tc_Name="TC_Transportation_Dispatch_Notice_SC_TDN_19";

		String File_Path_SC19 = TestNgXml.getfilePath_FromExecution().get(tc_Name);
		String Sheet_Name_SC19 = TestNgXml.getsheetName_FromExecution().get(tc_Name);
		String url = TestNgXml.getdatafromExecution().get(tc_Name);
		Map<String, String> TDN_SC_19 = Utils.GetAllData(Sheet_Name_SC19, tc_Name, "Dataset"+selected_dataset, File_Path_SC19);
		
		
		String username=TDN_SC_19.get("Username");
		String password=TDN_SC_19.get("Password");
		String moduleTDN=TDN_SC_19.get("ModuleTDN");
		String agencyUser = TDN_SC_19.get("AgencyUser");
		String Booking_Number =TDN_SC_19.get("Booking_Number");
		String Provisional_perform =TDN_SC_19.get("Provisional_perform");
		String Confirmed_perform =TDN_SC_19.get("Confirmed_perform");
		String Cancelled_perform =TDN_SC_19.get("Cancelled_perform");
		String Shipment_Type =TDN_SC_19.get("Shipment_Type");
		String Booking_Number_perform =TDN_SC_19.get("Booking_Number_perform");
		String Ware_House_number =TDN_SC_19.get("Ware_House_number");
		String Trans_select =TDN_SC_19.get("Trans_select");
		String App_Date =TDN_SC_19.get("App_Date");
		String date_Picker =TDN_SC_19.get("date_Picker");
		String tdn_SavedPopup =TDN_SC_19.get("TDN_SavedPopup");
		String Modeof_Transport =TDN_SC_19.get("Modeof_Transport");
		String Modeof_Transport_Type =TDN_SC_19.get("Modeof_Transport_Type");
		String Vender_Code =TDN_SC_19.get("Vender_Code");
		String Vender_Code1 =TDN_SC_19.get("Vender_Code1");
		String Return_Date =TDN_SC_19.get("Return_Date");
		String Transportation_saved =TDN_SC_19.get("Transportation_saved");
		String Global_search_Wo_No =TDN_SC_19.get("Global_search_Wo_No");
		String Global_search_Vendor_Code_Option1 =TDN_SC_19.get("Global_search_Vendor_Code_Option1");
		String Global_search_Option1 =TDN_SC_19.get("Global_search_Option1");
		String Dropdown_Condition =TDN_SC_19.get("Dropdown_Condition");
		String merchantPopup =TDN_SC_19.get("MerchantPopup");
		String pickup_loc_dd_data =TDN_SC_19.get("pickup_loc_dd_data");
		String pickup_loc_search_data =TDN_SC_19.get("pickup_loc_search_data");
		String condition =TDN_SC_19.get("condition");
		String cust_depot_term_data =TDN_SC_19.get("cust_depot_term_data");
		String cust_dep_search_data =TDN_SC_19.get("cust_dep_search_data");
		String return_loc_dd_data =TDN_SC_19.get("return_loc_dd_data");
		String return_loc_search_data =TDN_SC_19.get("return_loc_search_data");
		String leg_pickupdate =TDN_SC_19.get("leg_pickupdate");
		String leg_return_date =TDN_SC_19.get("leg_return_date");
		String with_chasis_flag =TDN_SC_19.get("with_chasis_flag");
		String chasis_pickup_dd_data =TDN_SC_19.get("chasis_pickup_dd_data");
		String chasis_drop_dd_data =TDN_SC_19.get("chasis_drop_dd_data");
		
		String cust_depot_term_header =TDN_SC_19.get("cust_depot_term_header");
		String return_location_header =TDN_SC_19.get("return_location_header");
		String pickup_location_header =TDN_SC_19.get("pickup_location_header");
		String chasis_pickup_header =TDN_SC_19.get("chasis_pickup_header");
		String chasis_drop_header =TDN_SC_19.get("chasis_drop_header");
		String chasis_pickup_Search_data =TDN_SC_19.get("chasis_pickup_Search_data");
		String chasis_drop_Search_data =TDN_SC_19.get("chasis_drop_Search_data");
		String Chassis_Mode =TDN_SC_19.get("Chassis_Mode");
		String Search_Type2 =TDN_SC_19.get("Search_Type2");
		String Search_Input2 =TDN_SC_19.get("Search_Input2");
		String Search_Type3 =TDN_SC_19.get("Search_Type3");
		String Search_Input3 =TDN_SC_19.get("Search_Input3");
...
//4
		...
		Step_End(23, "select Trans. Type Mode as pickup only in drop down.", test, test1);
		  ...
		  if (date_Picker.equalsIgnoreCase("Yes")) {
			  ...
			  selectDatePickerWithTime1(driver, pickupdate, Return_Date);
			  
			} else {
				waitForElement(driver, pickupdate);
				clearAndType(driver, pickupdate, Return_Date);
			}
		  
		Step_Start(24, "click add button and close the pop window.", test, test1);
		 waitForElement(driver, pickupdateclose);
	    ...
	    horizontalscroll(driver, TDN_ref_scroll, 3000);
	    
	    String vender_code = getText(driver, vendercode);
	    System.out.println("get_vender_code:" + vender_code);
	    ...
	    Step_Start(29, "click the search icon in vendor details, enter % in vendor code and select the New vendor.", test, test1);

	    waitForElement(driver, vendor_searchicon);
	    click(driver, vendor_searchicon);
	    globalValueSearchWindow(driver, Dropdown_Condition, Global_search_Vendor_Code_Option1, Vender_Code1, Search_Type2, Search_Input2, Search_Type3, Search_Input3);

	    Step_End(29, "click the search icon in vendor details, enter % in vendor code and select the New vendor.", test, test1);
	    ...
	    String vender_code1 = getText(driver, vendercode);
	    System.out.println("get_vender_code:" + vender_code1);
	    
	    horizontalscroll(driver, TDN_ref_scroll, -3000);
	    
	    if(!vender_code.equals(vender_code1)) {                                                                                                                  
			System.out.println("Matched || " + " Vendor code before edit is : " + vender_code + " || Vendor code after edit is : " + vender_code1);   
			Extent_pass(driver, "Matched || " + " Vendor code before edit is : " + vender_code + " || Vendor code after edit is : " + vender_code1, test, test1);
		}                                                                                                                                                                        
		else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Vendor code before edit is : " + vender_code + " || Vendor code after edit is : " + vender_code1);        
			Extent_fail(driver, "Not Matched || " + " Vendor code before edit is : " + vender_code + " || Vendor code after edit is : " + vender_code1, test,test1); 
		} 
