...
public class TC_Transportation_Dispatch_Notice_SC_TDN_22 extends Keywords{

	public void Transportation_Dispatch_Notice_SC_TDN_22(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {
		String testCase_Name ="TC_Transportation_Dispatch_Notice_SC_TDN_22";
		String File_Path_SC22 = TestNgXml.getfilePath_FromExecution().get(testCase_Name);
		String Sheet_Name_SC22 = TestNgXml.getsheetName_FromExecution().get(testCase_Name);
		String url = TestNgXml.getdatafromExecution().get(testCase_Name);
		Map<String, String> TDN_SC_22 = Utils.GetAllData(Sheet_Name_SC22, testCase_Name, "Dataset"+selected_dataset, File_Path_SC22);


		String username=TDN_SC_22.get("Username");
		String password=TDN_SC_22.get("Password");
		String moduleTDN=TDN_SC_22.get("ModuleTDN");
		String agencyUser = TDN_SC_22.get("AgencyUser");
		String Provisional_perform =TDN_SC_22.get("Provisional_perform");
		String Confirmed_perform =TDN_SC_22.get("Confirmed_perform");
		String Cancelled_perform =TDN_SC_22.get("Cancelled_perform");
		String Shipment_Type =TDN_SC_22.get("Shipment_Type");
		String Booking_Number_perform =TDN_SC_22.get("Booking_Number_perform");
		String Trans_select =TDN_SC_22.get("Trans_select");
		String App_Date =TDN_SC_22.get("App_Date");
		String date_Picker =TDN_SC_22.get("date_Picker");
		String tdn_SavedPopup =TDN_SC_22.get("TDN_SavedPopup");
		String Modeof_Transport =TDN_SC_22.get("Modeof_Transport");
		String Modeof_Transport_Type =TDN_SC_22.get("Modeof_Transport_Type");
		String Vender_Code =TDN_SC_22.get("Vender_Code");
		String merchantPopup =TDN_SC_22.get("MerchantPopup");
		String Transportation_Updated =TDN_SC_22.get("Transportation_Updated");
		String pickup_loc_dd_data =TDN_SC_22.get("pickup_loc_dd_data");
		String pickup_loc_search_data =TDN_SC_22.get("pickup_loc_search_data");
		String condition =TDN_SC_22.get("condition");
		String cust_depot_term_data =TDN_SC_22.get("cust_depot_term_data");
		String cust_dep_search_data =TDN_SC_22.get("cust_dep_search_data");
		String return_loc_dd_data =TDN_SC_22.get("return_loc_dd_data");
		String return_loc_search_data =TDN_SC_22.get("return_loc_search_data");
		String leg_date_Picker =TDN_SC_22.get("leg_date_Picker");
		String leg_pickupdate =TDN_SC_22.get("leg_pickupdate");
		String with_chasis_flag =TDN_SC_22.get("with_chasis_flag");
		String chasis_pickup_dd_data =TDN_SC_22.get("chasis_pickup_dd_data");
		String chasis_drop_dd_data =TDN_SC_22.get("chasis_drop_dd_data");
		String chasis_pickup_Search_data =TDN_SC_22.get("chasis_pickup_Search_data");
		String chasis_drop_Search_data =TDN_SC_22.get("chasis_drop_Search_data");
		String Chassis_Mode =TDN_SC_22.get("Chassis_Mode");
		String Return_Date =TDN_SC_22.get("Return_Date");

		String Booking_Number1 =TDN_SC_22.get("Booking_Number1");
		String Booking_Number2 =TDN_SC_22.get("Booking_Number2");
		String Booking_Number3 =TDN_SC_22.get("Booking_Number3");
		String Booking_Number_Type_Select1 =TDN_SC_22.get("Booking_Number_Type_Select1");
		String Booking_Number_Type_Select2 =TDN_SC_22.get("Booking_Number_Type_Select2");
		String Booking_Number_Type_Select3 =TDN_SC_22.get("Booking_Number_Type_Select3");
		String ware_House_Type_Select1 =TDN_SC_22.get("ware_House_Type_Select1");
		String Ware_House_number1 =TDN_SC_22.get("Ware_House_number1");
		String ware_House_Type_Select2 =TDN_SC_22.get("ware_House_Type_Select2");
		String Ware_House_number2 =TDN_SC_22.get("Ware_House_number2");
		String ware_House_Type_Select3 =TDN_SC_22.get("ware_House_Type_Select3");
		String Ware_House_number3 =TDN_SC_22.get("Ware_House_number3");
		String Dropdown_Condition =TDN_SC_22.get("Dropdown_Condition");
		String cust_depot_term_header =TDN_SC_22.get("cust_depot_term_header");
		String return_location_header =TDN_SC_22.get("return_location_header");
		String pickup_location_header =TDN_SC_22.get("pickup_location_header");
		String chasis_pickup_header =TDN_SC_22.get("chasis_pickup_header");
		String chasis_drop_header =TDN_SC_22.get("chasis_drop_header");
		String Global_search_Vendor_Code_Option1 =TDN_SC_22.get("Global_search_Vendor_Code_Option1");
		String Vendor_Search_Type2 =TDN_SC_22.get("Vendor_Search_Type2");
		String Vendor_Search_Input2 =TDN_SC_22.get("Vendor_Search_Input2");
		String Vendor_Search_Type3 =TDN_SC_22.get("Vendor_Search_Type3");
		String Vendor_Search_Input3 =TDN_SC_22.get("Vendor_Search_Input3");
		...
		if(actual_UpdatedPopup.equals(Transportation_Updated)) {
			Extent_pass(driver, "Matched || Expected Pop up : "+Transportation_Updated +" || Actual Pop up : "+actual_UpdatedPopup, test, test1);
			System.out.println("Matched || Expected Pop up : "+Transportation_Updated +" || Actual Pop up : "+actual_UpdatedPopup);
		}else {
			System.out.println("Not Matched || Expected Pop up : "+Transportation_Updated +" || Actual Pop up : "+actual_UpdatedPopup);
			Extent_fail(driver, "Not Matched || Expected Pop up : "+Transportation_Updated +" || Actual Pop up : "+actual_UpdatedPopup, test, test1);
		}
		...
		Step_Start(29, "Click the Return Date and select the New date", test, test1);
		...
		Step_End(29, "Click the Return Date and select the New date", test, test1);
		waitForElement(driver, vendor_Code_addbtn);
		click(driver, vendor_Code_addbtn);
		waitForDisplay(driver, tdnPopup_Ok);
		if (isdisplayed(driver, tdnPopup_Ok)) {
		...
		if(Transportation_Updated.contains(Transportation_dispatch_savedpopup)) {                                                                                                                  
			System.out.println("Matched || " + " Expected Report Activity is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup);   
			Extent_pass(driver, "Matched || " + " Expected Report Activity is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup, test, test1);
		}else {                                                                                                                                                                   
			System.out.println("Not Matched || " + " Expected Report Activity is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup);        
			Extent_fail(driver, "Not Matched || " + " Expected Report Activity is : " + Transportation_Updated + " || Actual Report Activity is : " + Transportation_dispatch_savedpopup, test,test1); 
		} 
