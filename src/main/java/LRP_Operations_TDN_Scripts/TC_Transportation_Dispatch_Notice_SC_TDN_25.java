...
public class TC_Transportation_Dispatch_Notice_SC_TDN_25 extends Keywords{

	public void Transportation_Dispatch_Notice_SC_TDN_25(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {		
		String testCase_Name ="TC_Transportation_Dispatch_Notice_SC_TDN_25";
		String File_Path_SC25 = TestNgXml.getfilePath_FromExecution().get(testCase_Name);
		String Sheet_Name_SC25 = TestNgXml.getsheetName_FromExecution().get(testCase_Name);
		String url = TestNgXml.getdatafromExecution().get(testCase_Name);
		Map<String, String> TDN_SC_25 = Utils.GetAllData(Sheet_Name_SC25, testCase_Name, "Dataset"+selected_dataset, File_Path_SC25);

		String username=TDN_SC_25.get("Username");
		String password=TDN_SC_25.get("Password");
		String moduleTDN=TDN_SC_25.get("ModuleTDN");
		String agencyUser = TDN_SC_25.get("AgencyUser");
		String Provisional_perform =TDN_SC_25.get("Provisional_perform");
		String Confirmed_perform =TDN_SC_25.get("Confirmed_perform");
		String Cancelled_perform =TDN_SC_25.get("Cancelled_perform");
		String Shipment_Type =TDN_SC_25.get("Shipment_Type");
		String Booking_Number_perform =TDN_SC_25.get("Booking_Number_perform");
		String Trans_select =TDN_SC_25.get("Trans_select");
		String App_Date =TDN_SC_25.get("App_Date");
		String date_Picker =TDN_SC_25.get("date_Picker");
		String Modeof_Transport =TDN_SC_25.get("Mode_Of_Transport");
		String tdn_SavedPopup =TDN_SC_25.get("TDN_SavedPopup");
		String return_Date=TDN_SC_25.get("return_Date");
		String vendor_Details_Data =TDN_SC_25.get("Vendor_Details_Input");
		String vendor_Code_Data =TDN_SC_25.get("Vendor_Code_Input");
		String vendor_City_Data =TDN_SC_25.get("City");
		String vendor_Name_Data =TDN_SC_25.get("Vendor_Name_Input");
		String warning_Message_Expected =TDN_SC_25.get("Warning_Message");
		String merchantPopup =TDN_SC_25.get("MerchantPopup");
		String Transportation_Updated =TDN_SC_25.get("Transportation_Updated");
		String pickup_loc_dd_data =TDN_SC_25.get("pickup_loc_dd_data");
		String pickup_loc_search_data =TDN_SC_25.get("pickup_loc_search_data");
		String condition =TDN_SC_25.get("condition");
		String cust_depot_term_data =TDN_SC_25.get("cust_depot_term_data");
		String cust_dep_search_data =TDN_SC_25.get("cust_dep_search_data");
		String return_loc_dd_data =TDN_SC_25.get("return_loc_dd_data");
		String return_loc_search_data =TDN_SC_25.get("return_loc_search_data");
		String leg_date_Picker =TDN_SC_25.get("leg_date_Picker");
		String leg_pickupdate =TDN_SC_25.get("leg_pickupdate");
		String with_chasis_flag =TDN_SC_25.get("with_chasis_flag");
		String chasis_pickup_dd_data =TDN_SC_25.get("chasis_pickup_dd_data");
		String chasis_drop_dd_data =TDN_SC_25.get("chasis_drop_dd_data");
		String chasis_pickup_Search_data =TDN_SC_25.get("chasis_pickup_Search_data");
		String chasis_drop_Search_data =TDN_SC_25.get("chasis_drop_Search_data");
		String Chassis_Mode =TDN_SC_25.get("Chassis_Mode");
		String Trans_ModeType =TDN_SC_25.get("Trans_ModeType");
		String Booking_Number1 =TDN_SC_25.get("Booking_Number1");
		String Booking_Number2 =TDN_SC_25.get("Booking_Number2");
		String Booking_Number3 =TDN_SC_25.get("Booking_Number3");
		String Booking_Number_Type_Select1 =TDN_SC_25.get("Booking_Number_Type_Select1");
		String Booking_Number_Type_Select2 =TDN_SC_25.get("Booking_Number_Type_Select2");
		String Booking_Number_Type_Select3 =TDN_SC_25.get("Booking_Number_Type_Select3");
		String ware_House_Type_Select1 =TDN_SC_25.get("ware_House_Type_Select1");
		String Ware_House_number1 =TDN_SC_25.get("Ware_House_number1");
		String ware_House_Type_Select2 =TDN_SC_25.get("ware_House_Type_Select2");
		String Ware_House_number2 =TDN_SC_25.get("Ware_House_number2");
		String ware_House_Type_Select3 =TDN_SC_25.get("ware_House_Type_Select3");
		String Ware_House_number3 =TDN_SC_25.get("Ware_House_number3");
		String Dropdown_Condition =TDN_SC_25.get("Dropdown_Condition");
		String cust_depot_term_header =TDN_SC_25.get("cust_depot_term_header");
		String return_location_header =TDN_SC_25.get("return_location_header");
		String pickup_location_header =TDN_SC_25.get("pickup_location_header");
		String chasis_pickup_header =TDN_SC_25.get("chasis_pickup_header");
		String chasis_drop_header =TDN_SC_25.get("chasis_drop_header");
		...
		List<WebElement> tdn_leg =listOfElements(driver, TDN_Leg);
		scrollBottom(driver);
		action.keyDown(Keys.SHIFT).build().perform();
		for(int i=0;i<tdn_leg.size();i++) {
			WebElement legsToSelect = tdn_leg.get(i);
			waitForElement(driver, TDN_Leg);
			Click(driver, legsToSelect);
		}
		action.keyUp(Keys.SHIFT).build().perform();

		Step_End(28, " Select the Draft TDN Container leg", test, test1);
		Step_Start(29, "Click the Remove button", test, test1);
		...
		Step_End(29, "Click the Remove button", test, test1);
