...
public class TC_Transportation_Dispatch_Notice_SC_TDN_15 extends Keywords{

	public void Transportation_Dispatch_Notice_SC_TDN_15(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) {
		
		String tc_Name="TC_Transportation_Dispatch_Notice_SC_TDN_15";

		String File_Path_SC15 = TestNgXml.getfilePath_FromExecution().get(tc_Name);
		String Sheet_Name_SC15 = TestNgXml.getsheetName_FromExecution().get(tc_Name);
		String url = TestNgXml.getdatafromExecution().get(tc_Name);
		Map<String, String> TDN_SC_15 = Utils.GetAllData(Sheet_Name_SC15, tc_Name, "Dataset"+selected_dataset, File_Path_SC15);
		
		
		String username=TDN_SC_15.get("Username");
		String password=TDN_SC_15.get("Password");
		String moduleTDN=TDN_SC_15.get("ModuleTDN");
		String agencyUser = TDN_SC_15.get("AgencyUser");
		String Load_Status =TDN_SC_15.get("Load_Status");
		String Booking_Number =TDN_SC_15.get("Booking_Number");
		String Shipment_Type =TDN_SC_15.get("Shipment_Type");
		String Booking_Number_perform =TDN_SC_15.get("Booking_Number_perform");
		String Modeof_Transport =TDN_SC_15.get("Modeof_Transport");
		String Vender_Code =TDN_SC_15.get("Vender_Code");
		String Transportation_saved =TDN_SC_15.get("Transportation_saved");
		String Dropdown_Condition =TDN_SC_15.get("Dropdown_Condition");
		String Global_search_Wo_No =TDN_SC_15.get("Global_search_Wo_No");
		String Global_search_Vendor_Code_Option1 =TDN_SC_15.get("Global_search_Vendor_Code_Option1");

		String pickup_loc_dd_data =TDN_SC_15.get("pickup_loc_dd_data");
		String pickup_loc_search_data =TDN_SC_15.get("pickup_loc_search_data");
		String condition =TDN_SC_15.get("condition");
		String cust_depot_term_data =TDN_SC_15.get("cust_depot_term_data");
		String cust_dep_search_data =TDN_SC_15.get("cust_dep_search_data");
		String return_loc_dd_data =TDN_SC_15.get("return_loc_dd_data");
		String return_loc_search_data =TDN_SC_15.get("return_loc_search_data");
		String leg_pickupdate =TDN_SC_15.get("leg_pickupdate");
		String leg_return_date =TDN_SC_15.get("leg_return_date");
		String with_chasis_flag =TDN_SC_15.get("with_chasis_flag");
		String chasis_pickup_dd_data =TDN_SC_15.get("chasis_pickup_dd_data");
		String chasis_drop_dd_data =TDN_SC_15.get("chasis_drop_dd_data");
		
		String cust_depot_term_header =TDN_SC_15.get("cust_depot_term_header");
		String return_location_header =TDN_SC_15.get("return_location_header");
		String pickup_location_header =TDN_SC_15.get("pickup_location_header");
		String chasis_pickup_header =TDN_SC_15.get("chasis_pickup_header");
		String chasis_drop_header =TDN_SC_15.get("chasis_drop_header");
		String chasis_pickup_Search_data =TDN_SC_15.get("chasis_pickup_Search_data");
		String chasis_drop_Search_data =TDN_SC_15.get("chasis_drop_Search_data");
		String Chassis_Mode =TDN_SC_15.get("Chassis_Mode");
		String Search_Type2 =TDN_SC_15.get("Search_Type2");
		String Search_Input2 =TDN_SC_15.get("Search_Input2");
		String Search_Type3 =TDN_SC_15.get("Search_Type3");
		String Search_Input3 =TDN_SC_15.get("Search_Input3");
...
waitForDisplay(driver, NewButton_ToolBar);
	...
	if(isdisplayed(driver, NewButton_ToolBar) && isElementAccessible(driver, NewButton_ToolBar)) {
		...
		Step_Start(6, "Select the Barge in Mode of Transport Dropdown.", test, test1);
		...
		Step_End(6, "Select the Barge in Mode of Transport Dropdown.", test, test1);
...
waitForElement(driver, load_status);			
			...
			Step_End(10, " Click the Add button and click the Exit icon.", test, test1);
