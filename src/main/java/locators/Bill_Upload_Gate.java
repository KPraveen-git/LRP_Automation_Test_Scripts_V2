...
public interface Bill_Upload_Gate extends CAR_Approval_Locators{
	...
	// TC_Scale_Out_TS_045
		...
		public static String Tool_Panel_Bill_Upload_Gate = "Tool_Panel_Bill_Upload_Gate>//div[@id='BUG-BUG_billUploadGateTreeTable_nfr_toolpanel_li_id']";
		public static String Condition_Filter_Bill_Upload_Gate = "Condition_Filter_Bill_Upload_Gate>//a[@id='BUG-BUG_billUploadGateTreeTable_conditionFilter_id']";
	    public static String Contract_No_Filter="Contract_No_Filter>//input[@aria-label='Contract No. Filter Input']";
		public static String Billing_Period_Filter = "Billing_Period_Filter>//input[@aria-label='Billing Period Filter Input']";
