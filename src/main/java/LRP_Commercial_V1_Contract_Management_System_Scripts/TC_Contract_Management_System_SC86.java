...
public class TC_Contract_Management_System_SC86 extends Keywords{
	...
	public void Contract_Management_System_SC86(WebDriver driver, ExtentTest test,ExtentTest test1, String selected_dataset) {
	
		String testCaseName="TC_Contract_Management_System_SC86";
...
//		}
		...
		if(Activated_val.equals(Activated)) {
			Extent_pass(driver,"Matched || Expected value is : "+Activated_val+" Actual value is : "+ Activated_avl, test,test1);
			System.out.println("Matched || Expected value is : "+Activated_val+" Actual value is : "+ Activated_avl);
		}else {
			
			Extent_fail(driver,"Not Matched || Expected value is : "+Activated_val+" Actual value is : "+ Activated_avl, test,test1);
			System.out.println("Not Matched || Expected value is : "+Activated_val+" Actual value is : "+ Activated_avl);
