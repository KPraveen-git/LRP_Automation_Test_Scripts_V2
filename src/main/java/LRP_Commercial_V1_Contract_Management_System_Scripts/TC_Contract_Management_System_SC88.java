...
public class TC_Contract_Management_System_SC88 extends Keywords {
	public static String Pre_Carriage_Radiobtn;
	public static String On_Carriage_Radiobtn;
	public static String tService;
	public static String TOS;

	public void Contract_Management_System_SC88(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset) {

		String testCaseName = "TC_Contract_Management_System_SC88";
