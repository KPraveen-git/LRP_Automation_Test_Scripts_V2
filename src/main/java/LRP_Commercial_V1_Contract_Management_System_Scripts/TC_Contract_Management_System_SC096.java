...
public class TC_Contract_Management_System_SC096 extends Keywords {
	...
	public void Contract_Management_System_SC96(WebDriver driver, ExtentTest test, ExtentTest test1,
			String selected_dataset) {

		String testCaseName = "TC_Contract_Management_System_SC096";
		...
		String DimensionSheetName = Data.get("DimensionSheetName");
		...
		if (Contract_Activated_popup.equals(verified_popup2)) {
			Extent_pass(driver, "Matched || Expected value is : " + Contract_Activated_popup + " Actual value is: "
					+ verified_popup2, test, test1);
			System.out.println("Matched || Expected value is : " + Contract_Activated_popup + " Actual value is : "
					+ verified_popup2);
		} else {

			Extent_fail(driver, "Not Matched || Expected value is : " + Contract_Activated_popup + " Actual value is : "
					+ verified_popup2, test, test1);
