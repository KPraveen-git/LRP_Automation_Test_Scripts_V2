...
public class TC_Cost_Activity_Report_TS078 extends Keywords {
	
	public void  Cost_Activity_Report_TS078(WebDriver driver, ExtentTest test, ExtentTest test1,String selected_dataset) throws Exception{
		
		String tc_Name = "TC_Cost_Activity_Report_TS078";
		...
		Step_Start(2, "Enter the Activity code with the required alphabets and provide the required activity description. Select the activity type as 'Sub' and contract type as 'PTC'. Click the 'Add' option and then click the 'Save' option in the toolbar.", test, test1);
		...
		Step_End(2, "Enter the Activity code with the required alphabets and provide the required activity description. Select the activity type as 'Sub' and contract type as 'PTC'. Click the 'Add' option and then click the 'Save' option in the toolbar.", test, test1);

		Step_Start(3, "Enter the screen name as 'Global activity mapping' in the module search field.", test, test1);
	
		moduleNavigate(driver, gam_module);
		
		Step_End(3, "Enter the screen name as 'Global activity mapping' in the module search field.", test, test1);
		Step_Start(4, "Click the global search option and enter the contract code as 'PTC'. Check if the system retrieves it and then click the 'Edit' option.", test, test1);
		...
		Step_End(4, "Click the global search option and enter the contract code as 'PTC'. Check if the system retrieves it and then click the 'Edit' option.", test, test1);

		Step_Start(5, "Select the required main-activity and then select the required newly added sub-activities. Click the 'Add' option and then click the 'Save' option in the toolbar. Ensure that system validates as 'Global Activity Updated'. Click the 'OK' option.", test, test1);
		...
		Step_End(5, "Select the required main-activity and then select the required newly added sub-activities. Click the 'Add' option and then click the 'Save' option in the toolbar. Ensure that system validates as 'Global Activity Updated'. Click the 'OK' option.", test, test1);

		Step_Start(6, "Enter the screen name as 'Vendor contracts' in the module search field. Select the contract type as 'PTC'.", test, test1);
...
if(datepicker.equalsIgnoreCase("yes")) {
	...
	Step_Start(8, "System will pop up a confirmation message: 'Do you want to get activities from predictable activity behavior?' Click on 'No'.", test, test1);
	
		waitForElement(driver, popup_Message_No_Button);
		click(driver, popup_Message_No_Button);
		
		Step_End(8, "System will pop up a confirmation message: 'Do you want to get activities from predictable activity behavior?' Click on 'No'.", test, test1);
	...
	Step_Start(10, "Select the required main activity, right-click on it, and select the 'Remove selected items' option. Click 'Yes'.", test, test1);
		...
		Step_Start(11, "Select the required main activity, click on the 'Edit input fields' option, and select the required charge type, equipment type, equipment status, currency, and send to disbursement.", test, test1);
...
// Vendor Contracts 
		...
		Step_End(13, "Click the 'Save' option in the toolbar. System validates as 'Vendor contract saved'. Click the 'Accept' option. The system will ask for contract mapping. Click 'Yes'.", test, test1);
		Step_Start(14, "Next, the contract mapping screen opens. Enter the required port and terminal. Click the 'Save' option. Ensure that the system validates as 'Contract Mapping Saved'. Click the 'OK' option.", test, test1);
...
//  Contract Mapping
	...
	twoColumnSearchWindow(driver, Port_Code_Search, condition, Port_Code);
		...
		Step_End(14, "Next, the contract mapping screen opens. Enter the required port and terminal. Click the 'Save' option. Ensure that the system validates as 'Contract Mapping Saved'. Click the 'OK' option.", test, test1);
		Step_Start(15, "Switch to the required agency and enter the screen name as 'Cost activity report' in the module search field. Select the contract type as 'PTC'.", test, test1);
...
moduleNavigate(driver, Cost_Activity_Report_Module);
		...
		Step_End(15, "Switch to the required agency and enter the screen name as 'Cost activity report' in the module search field. Select the contract type as 'PTC'.", test, test1);
		Step_Start(16, "Enter the required service, vessel, port, terminal, arrival date using their respective search options and click the 'Show' option. Check if the created contract with the newly added activities is applied under the unpredictable reporting tab.", test, test1);
		...
		Step_End(16, "Enter the required service, vessel, port, terminal, arrival date using their respective search options and click the 'Show' option. Check if the created contract with the newly added activities is applied under the unpredictable reporting tab.", test, test1);
...
//	Predictable Activity Behaviour
		...
		Step_Start(18, "Click the global search option, enter the required fields, and click the 'Search' option. Next, select the required details and click the 'Select' option.", test, test1);
		...
		Step_End(19, "Click the 'Edit' option in the toolbar and map the required newly added sub-activities under the mapped main-activity.", test, test1);
		...
		Step_Start(20, "Click the 'Save' option in the toolbar. System validates as 'Predictable activity behaviour updated'.", test, test1);
		...
		Step_End(20, "Click the 'Save' option in the toolbar. System validates as 'Predictable activity behaviour updated'.", test, test1);
...
//	CAR
		...
		String PredictableActivity_Column=String.format(predictable_SubActivity_Column_CAR, activity_desc_data);
		String MainActivity_Column=String.format(predictable_MainActivity_Column_CAR, Main_Activity_Value);
		...
		Step_Start(23, "Click the 'Save' option in the toolbar. System validates as 'Container report activity saved'. Click the 'OK' option.", test, test1);
		...
		if(actualSavedPopup.equals(CAR_Saved_Poupup)) {
		...
		Step_End(23, "Click the 'Save' option in the toolbar. System validates as 'Container report activity saved'. Click the 'OK' option.", test, test1);
