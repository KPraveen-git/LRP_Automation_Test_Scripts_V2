...
public class TC_Lessor_Bill_Upload_TS_045_to_TS_046_C  extends Keywords {




	public void Lessorbillupload45_46(WebDriver driver, ExtentTest test,ExtentTest test1,String selected_dataset) throws EncryptedDocumentException, InvalidFormatException, IOException {
		// Value are taken from excel sheet
		String testcase_Name1 = "Lessor_Bill_Upload_TS_045";
		...
		Map<String, String> data1 = Utils.GetAllData(Sheet_Name1, testcase_Name1, "Dataset" + selected_dataset,
				File_Path1);
		...
		Step_Start(1, " Click Import Excel button & select Excel file accordingly ",test, test1);
	     ...
	     int TC2=2;
	    	     ...
	    	     if(TC2==2) {
	    	    	 ...
	    	    	 String testcase_Name2 = "Bill_Upload_Gate_TS_046";
	    	 	...
	    	 	String Popupforimporexp45 = data2.get ("Popupforupload");
	    	 	String Search145 = data2.get ("Search_input1");
	    	 	String Search45 =  data2.get("Search_input");
	    	 	String excelFilePath = data2.get ("excelFilePath");
	    	 	String Sheet_select = data2.get ("Sheet_select");
