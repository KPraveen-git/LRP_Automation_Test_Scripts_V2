	...
	public void equipmentReport29To32(WebDriver driver, ExtentTest test, ExtentTest test1, String selected_dataset)
		...
		if(TC1==1) {	
			...
			if (isDisplayed(driver, summaryOpt)) {
				System.out.println("***Before clicking the show button table data should not be displayed***");
				Extent_pass(driver, "***Before clicking the show button table data should not be displayed***", test,
						test1);
			} else {
			...
			waitForElement(driver, closeOption);
			click(driver, closeOption);
		}
		...
		if(TC2==1) {	
			...
			waitForElement(driver, closeSymbols);
			click(driver, closeSymbols);
			waitForElement(driver, dashboard_Title);
			click(driver, dashboard_Title);
			waitForElement(driver, closeOption);
			click(driver, closeOption);
		}
		...
		if(TC4==1) {
			...
			if (reportPop.equals(report_request_sentPopup)) {
				System.out.println("Matched || Expected value was : " + report_request_sentPopup + " || Actual value was : "
						+ reportPop);
				Extent_pass(driver, "Matched || Expected value was : " + report_request_sentPopup
